...
namespace JobPlacementDashboard.Controllers
{
    public class JPHiresController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string searchString)
        {
            ...
            {
                hires = hires.Where(s => s.ApplicationUser.FirstName.Contains(searchString)|| s.JPCompanyName.Contains(searchString) || s.JPJobCategory.ToString().Contains(searchString)
